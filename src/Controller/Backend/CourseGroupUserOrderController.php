...
class CourseGroupUserOrderController extends BackendController
{
    /**
     * @Route("/course/order/", name="course_order_index", methods="GET")
    ...
    /**
     * @Route("/course/order/{id}/edit", name="course_order_edit", methods="GET|POST")
     * @param Request $request
    ...
    /**
     * @Route("/course/order/export", name="course_order_export", methods="GET")
     * @param GroupUserOrderRepository $groupUserOrderRepository
     * @param Request $request
     * @return Response
     */
    public function export(GroupUserOrderRepository $groupUserOrderRepository, Request $request): Response
    {
         ...
         */
        $exportData = $groupUserOrderRepository->findOnlineCourseOrders($data['form']['groupUserOrderId'], $data['form']['userId'], $data['form']['productName'], $data['form']['status'], $data['form']['paymentStatus'])->getQuery()->getResult();
        ...
        return new StreamedResponse($callBack, 200, [
            ...
            'Content-Disposition' => 'attachment; filename="视频订单_'.date("Ymd_His").'.csv"'
        ]);
    }
